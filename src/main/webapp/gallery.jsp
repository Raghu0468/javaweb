...
pageEncoding="ISO-8859-1"%>
	...
	<div class = "flex-container"  ng-app="myApp" ng-controller="galleryCtrl">
   <div class = "row" >
   <div class="col-sm-10">
							...
							<div class="col-xs-12">
								...
								<div>
									<ul class="ace-thumbnails clearfix">
										...
										<li ng-repeat="image in data">
										
											<a href="assets/${image.image}" title="Photo Title" data-rel="colorbox">
												<img width="150" height="150" alt="150x150" src="assets/${image.thumb}" />
											</a>

											<div class="tags"  > 
												<span class="label-holder" ng-repeat="innerItem in image.tags">
													<span class="label label-${innerItem.type}">${innerItem.name}</span>
												</span>
