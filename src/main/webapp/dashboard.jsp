	...
	the lightweight, feature-rich and easy to use admin template.
								...
								<div class="row">
									...
									<div class="col-sm-7 infobox-container">
										...
										<span  ng-repeat="x in boxes">{{x}}
										<div class="infobox infobox-{{x.color}}">
											<div class="infobox-icon">
												<i class="ace-icon {{x.icon}}"></i>
											</div>

											<div class="infobox-data">
												<span class="infobox-data-number">{{x.number}}</span>
												<div class="infobox-content">{{x.content}}</div>
											</div>

											<!-- #section:pages/dashboard.infobox.stat -->
											<div class="stat stat-success">{{x.stat-success}}</div>
										...
										<span ng-repeat="com in completion">{{com.0}}
										<div class="infobox infobox-green infobox-small infobox-dark">
											<div class="infobox-progress">
												<!-- #section:pages/dashboard.infobox.easypiechart -->
												<div class="easy-pie-chart percentage" data-percent="61" data-size="39">
													<span class="percent">{{com.progress}}</span>%
												</div>
											...
											<div class="infobox-data">
												<div class="infobox-content">{{com.content}}</div>
